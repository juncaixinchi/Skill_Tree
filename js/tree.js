var tree = (function () {
    ...
    var w3school_url = 'http://www.w3school.com.cn';
    ...
    var tree, diagonal, vis, numOfSkills = 0, numOfClass = 0;
            ...
            csv.forEach(function (row) {
                ...
                for (var col in row) {
                    ...
                    if (!(type in uniqueTreeNode)) {
                        ...
                        if(row.hasOwnProperty('metaw3school')){
                        	uniqueTreeNode[type].w3school = row.metaw3school;
                        }
    ...
    function build(json) {
        ...
        update(root);
        numOfClass = root.children.length;
    ...
    function update(source) {
        ...
        .text(function (d) {
            ...
            var w3school_link = (typeof d.w3school !== 'undefined' && d.w3school != '') ? '<a class="qtip-link" href="' + w3school_url + '/' + d.mainType + '/' +d.w3school + '.asp' + '" target="_blank">' + d.w3school + '</a>' : 'Not Available';

            _qtipContent += '<b>Name:</b> ' + d.name.replace(/\(\w+\)/gi, '') + '<br/>';
            _qtipContent += '<b>Main type:</b> ' + d.mainType + '<br/>';
            _qtipContent += '<b>w3school:</b> ' + w3school_link  + '<br/>';
